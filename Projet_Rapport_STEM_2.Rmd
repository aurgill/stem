...
Parallèlement, le cycle des Beroe semble aligné sur un cycle annuel jusqu'aux alentours de 2007, ce qui est cohérent avec l'étude que nous avons tenté de reproduire. Toutefois en 2007, elles se synchronisent de façon passagère avec le cycle chlorophyllien, qui est de trois mois cette année-là. Ce résultat n'a pas été mis en évidence par l'étude de référence, qui ne visualise pas les périodes inférieures à 6 mois; toutefois les représentations graphiques sont globalement cohérentes avec les résultats de l'article initial.
